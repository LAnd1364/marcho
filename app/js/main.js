...
$('.filter-ptice__input').ionRangeSlider({
  type: "double",
  prefix: "$",
  onStart: function (data) {
    $('.filter-ptice__from').text(data.from);
    $('.filter-ptice__to').text(data.to);
  },
